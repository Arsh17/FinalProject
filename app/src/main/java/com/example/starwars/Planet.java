...
public class Planet {
        ...
        public Planet() throws IOException, JSONException {
            setClass();
        }
        ...
        public void setClass() throws IOException, JSONException{
            ...
            //}
            System.out.print("https://swapi.co/api/planets/" + y + "/");
            JSONObject json = readJsonFromUrl("https://swapi.co/api/planets/" + y + "/");
            if (json == null) {
                Planet x = new Planet();
                x.setClass();
            }
            name = json.get("name").toString();
            terrain = json.get("terrain").toString();
        }
        public String getclass() {
            if (terrain == null) {
                terrain = "THE API HAS FAILED US";
